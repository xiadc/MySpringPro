    ...
    this.addEvents = function () {
        ...
        if (this.timeLineChart) {
            ...
            this.timeLineChart.on('dataZoom', function (params) {
                ...
                var bg = timeData.title[Math.round(timeData.title.length * params.start / 100.0)].split("/");
                var ed = timeData.title[Math.round(timeData.title.length * params.end / 100.0)].split("/");
