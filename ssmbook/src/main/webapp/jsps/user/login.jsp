...
<script type="text/javascript">
	//用来回显用户名，优先回显request，如果其次是cookie中的用户名
	$(function(){
		var loginname =window.decodeURI("${cookie.loginname.value}");//需要解码，不然可能中文乱码
        ...
        <div class="login1">
	      <div class="login2">
            <div class="loginTopDiv">
              ...
              <span>
                <a href="<c:url value='/jsps/user/regist1.jsp'/>" class="registBtn"></a>
              </span>
            </div>
            <div>
