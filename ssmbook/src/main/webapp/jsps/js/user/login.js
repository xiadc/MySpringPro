$(function() {
	...
	$("#submit").hover(
		function() {
			$("#submit").attr("src", "/ssmbook/images/login2.jpg");
		},
		function() {
			$("#submit").attr("src", "/ssmbook/images/login1.jpg");
		}
	);
...
function validateVerifycode() {
	...
	if(!value) {//非空校验
		...
		$.ajax({
			...
			url: "/ssmbook/ajaxValidateVerifyCode.action",
...
function _hyz() {
	 ...
	 * 
	 */
	$("#vCode").attr("src","/ssmbook/VerifyCodeServlet?a="+new Date().getTime());
}
